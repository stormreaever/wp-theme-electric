...
if ( ! function_exists( 'electric_posted_on' ) ) :
	...
	function electric_posted_on() {
		...
		$byline = sprintf(
			...
			esc_html_x( 'by %s', 'post author', 'electric' ),
...
if ( ! function_exists( 'electric_entry_footer' ) ) :
	/**
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'electric' ),
						array(
							'span' => array(
								'class' => array(),
							),
...
if ( ! function_exists( 'electric_post_thumbnail' ) ) :
/**
 ...
 */
function electric_post_thumbnail() {
